...
public class RobotContainer {
    ...
    public final AutoShootCoral CMD_AutoShootCoral = new AutoShootCoral(coral, arm);
        ...
        drivetrain.setDefaultCommand(
            ...
            drivetrain.applyRequest(() ->
                drive.withVelocityX(-Driver_Ctrl.getLeftY() * MaxSpeed) // Drive forward with negative Y (forward)
                    ...
                    .withRotationalRate(-Driver_Ctrl.getRightX() * MaxAngularRate) // Drive counterclockwise with negative X (left)
            )
        );
